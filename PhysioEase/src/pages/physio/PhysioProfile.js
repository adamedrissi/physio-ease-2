    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <select name="speciality" title="This field cannot be changed" value={user.speciality || ''} disabled>
            ...
            <option value="generalRehabilitation">{t('generalRehabilitation')}</option>
