...
import '../../styles/physio/PhysioDirectMessages.css';
...
function DirectMessages() {
  ...
  useEffect(() => {
    setMessages([
      { id: 1, sender: 'Patient', content: 'I have a question about my treatment plan.' },
      { id: 2, sender: t('you'), content:  'Yes, what is it?'},
    ]);
  }, [t]);
